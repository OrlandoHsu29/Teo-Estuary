...
**Teo Estuary** 是一个开源的潮汕话语料收集与标注平台，致力于收集、整理潮汕话语料数据，用于训练潮汕话ASR 。平台名称取 "Estuary"（河口/汇流处）之意，象征各地的潮汕方言语料将在此汇聚，汇入世界的洋流。
...
开发该工具主要是为了做一个基于方言交互的终端，而现在的潮汕话ASR效果实在太差，而且我没法基于现有模型去做针对性适配，所以只能稍微从头造轮子，以满足我的项目需求，让更多说不好、不会说普通话的潮汕中老年人也能够享受到语音识别带来的便利性。
